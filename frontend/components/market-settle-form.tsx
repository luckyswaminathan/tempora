...
export function MarketSettleForm({ market, onSettled, onSettleSuccess, onCancel }: MarketSettleFormProps) {
    ...
    return (
      <Card className="p-4 border-green-200 bg-green-50 dark:bg-green-950/20">
        <div className="flex items-center justify-between">
          <div>
            <h4 className="font-semibold text-green-900 dark:text-green-100">Settled</h4>
    ...
    <Card className="p-4">
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mb-4">{market.question}</p>
        </div>

        <div>
          <Label htmlFor={`outcomes-${market.id}`}>Select Winning Outcome</Label>
          <select
